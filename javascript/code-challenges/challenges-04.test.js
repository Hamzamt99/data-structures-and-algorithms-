...
const sortMeetingsByDay = (arr) => {
  ...
  arr.sort((a, b) => sortedDays[a.dayOfWeek.toLowerCase()] - sortedDays[b.dayOfWeek.toLowerCase()]);
  return arr;
};
...
const sortSchedule = (arr) => {
  ...
  arr.sort((a, b) => {
    if (a.dayOfWeek + a.start === b.dayOfWeek + b.start) {
      ...
      return sortedDays[a.dayOfWeek.toLowerCase()] - sortedDays[b.dayOfWeek.toLowerCase()];
    }
  });
  return arr;
};
